...
<nav
    ...
    className="group fixed top-1/2 left-0 z-50 -translate-y-1/2 rounded-r-xl border border-l-0 border-transparent py-4 pr-4 pl-3 transition duration-200 hover:border-slate-200 hover:bg-white hover:shadow-lg focus-within:border-slate-200 focus-within:bg-white focus-within:shadow-lg"
>
        ...
        {sections.map((section) => (
            <li key={section.title}>
                <a
                    ...
                    className="flex flex-row items-center gap-3 text-slate-400 transition-colors duration-200 hover:text-cyan-600 focus-visible:text-cyan-600 focus-visible:outline-none"
                >
